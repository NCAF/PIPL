...
<div class="card">
    <div class="card-body">
        <a href="{{ route('destinasi.index') }}" class="text-decoration-none d-flex" id="back">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#detailModal{{ $dst->id }}">
                                Detail
                            </button>
                            <!-- Modal -->
                            <div class="modal fade" id="detailModal{{ $dst->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="{{ asset('foto_destinasi/' . $dst->foto) }}" class="img-fluid" alt="Foto" style="max-width: 100%; height: auto;">
                                            <p>{{ $dst->deskripsi }}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <td class="align-middle text-center">
                            <span>
                                <button data-toggle="modal" data-target="#editDestinasiModal{{ $dst->id }}" type="button" class="btn btn-info">Edit</button>
                                <form id="deleteForm-{{ $dst->id }}" method="post" action="{{ route('destinasi.destroy', $dst->id) }}" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button" class="btn btn-danger" onclick="confirmDelete('{{ $dst->id }}')">Delete</button>
                                </form>
                                <script>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="destinasi_awal" name="destinasi_awal" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="destinasi_akhir" class="form-label">Destinasi Akhir</label>
                                    <input type="text" class="form-control" id="destinasi_akhir" name="destinasi_akhir" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="hari_berangkat" name="hari_berangkat" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="jumlah_bagasi" name="jumlah_bagasi" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
    ...
    <div class="modal fade" id="editDestinasiModal{{ $dst->id }}" tabindex="-1" aria-labelledby="editDestinasiModalLabel{{ $dst->id }}" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="destinasi_awal" class="form-label">Destinasi Awal</label>
                                    <input type="text" class="form-control" id="destinasi_awal" name="destinasi_awal" value="{{ $dst->destinasi_awal }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="destinasi_akhir" class="form-label">Destinasi Akhir</label>
                                    <input type="text" class="form-control" id="destinasi_akhir" name="destinasi_akhir" value="{{ $dst->destinasi_akhir }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="jenis_kendaraan" class="form-label">Jenis Kendaraan</label>
                                    <input type="text" class="form-control" id="jenis_kendaraan" name="jenis_kendaraan" value="{{ $dst->jenis_kendaraan }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="no_plat" class="form-label">Nomor Plat</label>
                                    <input type="text" class="form-control" id="no_plat" name="no_plat" value="{{ $dst->no_plat }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="hari_berangkat" class="form-label">Hari Berangkat</label>
                                    <input type="date" class="form-control" id="hari_berangkat" name="hari_berangkat" value="{{ $dst->hari_berangkat }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="jumlah_kursi" class="form-label">Jumlah Kursi</label>
                                    <input type="number" class="form-control" id="jumlah_kursi" name="jumlah_kursi" value="{{ $dst->jumlah_kursi }}" required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="jumlah_bagasi" class="form-label">Jumlah Bagasi</label>
                                    <input type="number" class="form-control" id="jumlah_bagasi" name="jumlah_bagasi" value="{{ $dst->jumlah_bagasi }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
